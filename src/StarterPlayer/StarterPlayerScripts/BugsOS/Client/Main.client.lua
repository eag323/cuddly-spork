...
local requiredRemoteNames = {
	...
	MarketSetAutoSellEnabled = RemoteNames.Market_SetAutoSellEnabled,
	MarketSetAutoSellTarget = RemoteNames.Market_SetAutoSellTarget,
	...
	BugFarmCombatTeamResult = RemoteNames.BugFarm_CombatTeamResult,
...
local context = { State = { PlayerData = nil, Market = { Price = 1, History = { 1 }, MarketCap = 3.0, Alerts = { Above = 2.5, Below = 0.75 }, AlertState = { AboveTriggered = false, BelowTriggered = false } } }, UI = {}, Remotes = remotes, Controllers = {}, Events = {} }
