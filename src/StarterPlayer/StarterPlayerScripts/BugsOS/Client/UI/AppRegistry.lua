...
local AppRegistry = {
	{ Id = "Achievements", Title = "Achievements.exe", IconImage = UIAssets.AppIconImages.Achievements, DefaultWindowSize = UDim2.fromOffset(900, 600), Module = require(Apps:WaitForChild("AchievementsApp")), UnlockedByDefault = true, AllowDuplicate = false },
