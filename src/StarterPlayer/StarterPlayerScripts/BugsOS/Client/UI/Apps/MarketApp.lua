...
function MarketApp.Mount(target, context)
	...
	windowRef = Window.Create({Title="Market.exe", Size=UDim2.fromOffset(560,380), Position=UDim2.fromScale(0.1,0.18), Parent=target, OnClose=function() context.Controllers.Window.Close("Market") end})
